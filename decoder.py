...
def decoder_menu(user_inp):
    if (user_inp == 1):
        ...
        user_option = input(color.RED+"\n[⚡] "+color.RED+"Amj.crypto"+color.LIGHTCYAN_EX+'/'+color.LIGHTWHITE_EX+"home"+color.LIGHTCYAN_EX+'/'+color.LIGHTWHITE_EX+"base64-Dcryptor"+color.LIGHTCYAN_EX+'/'+color.LIGHTRED_EX+" ⇒ " )
        ...
        user_option = input(color.RED+"\n[⚡] "+color.RED+"Amj.crypto"+color.LIGHTCYAN_EX+'/'+color.LIGHTWHITE_EX+"home"+color.LIGHTCYAN_EX+'/'+color.LIGHTWHITE_EX+"Rot13-Dcryptor"+color.LIGHTCYAN_EX+'/'+color.LIGHTRED_EX+" ⇒ " )
